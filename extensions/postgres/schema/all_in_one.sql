...
CREATE TABLE xdb_sys_process_executions(
    ...
    status SMALLINT, -- 0:not_started/1:running/2:completed/3:failed/4:timeout
...
CREATE TABLE xdb_sys_async_state_executions(
   ...
   --
   wait_until_status SMALLINT NOT NULL, -- 0:skipped/1:running/2:completed/3:failed/4:timeout
   execute_status SMALLINT, -- 0:not_started/1:running/2:completed/3:failed/4:timeout
