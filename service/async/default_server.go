...
const PathSignalProcessCompletion = "/internal/api/v1/xcherry/signal-process-completion"
...
func NewDefaultAsyncServerWithGin(
	...
	engine.POST(PathSignalProcessCompletion, handler.SignalProcessCompletion)
